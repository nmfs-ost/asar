...
Modifies a LaTeX report file to improve document accessibility. This
function automates the process of adding PDF tagging and integrating
alternative text for figures and tables.
...
No return value. Modifies files on disk and optionally renders a .pdf.

## Details

This function acts as a wrapper for the asar package's accessibility
workflow. It first applies document tagging via
[add_tagging](nmfs-ost.github.io/asar/reference/add_tagging.md) and then
injects alternative text using

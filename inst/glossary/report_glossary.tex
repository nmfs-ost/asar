...
\newacronym{adj}{Adj}{adjusted value, using Mohn's rho}
...
<<<<<<< HEAD
\newacronym{agepro}{AGEPRO}{Age-Structured Projection Model}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
<<<<<<< HEAD
\newacronym{aim}{AIM}{An Index Model}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{asm}{ASM}{at-sea monitoring}
...
\newacronym{bh}{BH}{Beverton--Holt (model for stock-recruitment)}
\newacronym{biop}{BiOp}{biological opinion}
\newacronym{bkc}{BKC}{blue king crab}
<<<<<<< HEAD
\newacronym{blls}{BLLS}{Bottom Longline Survey}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{btar}{BTar}{theoretically ideal biomass}
\newacronym{bterm}{BTerm}{terminal year biomass}
\newacronym{bthr}{BThr}{threshold for biomass that indicates overfished status}
...
\newacronym{ca-cali}{CA}{California}
\newacronym{ca-canada}{CA}{Canada}
\newacronym{caa}{CAA}{Catches-at-age}
...
\newacronym{chesmap}{CHESMAP}{Chesapeake Bay Multispecies Monitoring and Assessment Program}
...
\newacronym{cmmt}{cmmt}{metric tonnes of catch at least of specified length}
\newacronym{cmp}{CMP}{coastal migratory pelagics}
\newacronym{cmplus}{cmplus}{catch at least of specified length in centimeters}
...
<<<<<<< HEAD
\newacronym{conf.}{Conf.}{confidence}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{dmr}{DMR}{Department of Marine Resources}
...
<<<<<<< HEAD
\newacronym{ecomon}{ECOMON}{Ecosystem Monitoring}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
\newacronym{ecomon fall}{ECOMON Fall}{Northeast Ecosystem Monitoring (EcoMon)\_Fall}
...
\newacronym{efps}{EFPs}{Exempted Fishing permits}
\newacronym{efull}{EFull}{exploitation mortality on fully selected ages}
...
\newacronym{emsy}{$E_{MSY}$}{exploitation rate for maximum sustainable yield}
\newacronym{emsypr}{$E_{MSY}pr$}{proxy exploitation rate for maximum sustainable yield}
...
<<<<<<< HEAD
\newacronym{ess}{ESS}{expeditionary support ship}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{favg}{FAVG}{averaged fishing mortality}
...
\newacronym{ffull}{FFull}{fishing mortality on fully selected ages}
...
\newacronym{flat sel}{flat sel}{flat-topped survey selectivity}
...
\newacronym{fmsypr}{$F_{MSY}pr$}{proxy fishing rate for maximum sustainable yield}
...
\newacronym{fratio}{Fratio}{ratio of F to threshold for F}
\newacronym{frebuild}{FRebuild}{fishing mortality rate for stock rebuilding plan}
\newacronym{frfa}{FRFA}{final regulatory flexibility analysis}
\newacronym{frho}{Frho}{rho-adjusted value for the fishing rate}
\newacronym{fsitt}{FSITT}{Fishery-independent Survey in the Territories}
\newacronym{ftar}{FTar}{ideal fishing mortality level for sustainability}
\newacronym{fte}{FTE}{Full time employee}
\newacronym{fterm}{FTerm}{terminal year fishing mortality rate}
\newacronym{fthr}{FThr}{threshold fishing mortality for overfishing status}
\newacronym{fv}{FV}{fishing vessel}
...
\newacronym{garm}{GARM}{Groundfish Assessment Review Meeting}
\newacronym{garm iii}{GARM III}{3rd Groundfish Assessment Review Meeting, 2008}
...
\newacronym{goa-ak}{GOA}{Gulf of Alaska}
\newacronym{goa-se}{GOA}{Gulf of America}
=======
...
\newacronym{kgtow}{kgtow}{kilograms per tow}
...
\newacronym{kt}{kt}{kiloton = thousand metric tons}
...
<<<<<<< HEAD
\newacronym{lognorm}{lognorm}{probability distribution whose log is normal}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{lpue}{LPUE}{Landings Per Unit Effort}
...
\newacronym{mcmc}{MCMC}{Markov Chain Monte Carlo analysis}
...
\newacronym{medmr}{MEDMR}{Maine Department of Marine Resources}
...
\newacronym{mramp}{Mramp}{model: natural mortality ramped increase}
...
\newacronym{mrho}{Mrho}{Mohn's rho parameter (average relative bias)}
...
\newacronym{msp}{MSP}{maximum spawning potential}
...
\newacronym{naa}{NAA}{Numbers-at-age}
...
\newacronym{ndpswg}{NDPSWG}{Northeast Data Poor Stocks Working Group}
...
\newacronym{nefop}{NEFOP}{Northeast Fishery Observer Program}
...
\newacronym{njdep}{NJDEP}{New Jersey Department of Environmental Protection}
...
<<<<<<< HEAD
\newacronym{ntap}{NTAP}{Northeast Trawl Advisory Panel}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{nydec}{NYDEC}{New York Department of Environmental Conservation}
...
\newacronym{proj. adj.}{Proj. Adj.}{projected adjustment}
\newacronym{prp}{PRP}{Peer Review Panel}
...
\newacronym{recr}{Recr}{expected recruitment numbers}
...
\newacronym{ridem}{RIDEM}{Rhode Island Department of Environmental Management}
\newacronym{ridfawfs}{RIDFAWFS}{Rhode Island Department of Fish and Wildlife fall survey}
\newacronym{ridfw}{RIDFW}{Rhode Island Department of Fish and Wildlife}
...
\newacronym{rmsy}{$R_{MSY}$}{expected recruitment at MSY biomass}
...
<<<<<<< HEAD
\newacronym{sarc}{SARC}{Stock Assessment Review Committee}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{sasinf}{SASINF}{Stock Assessment Support Information}
...
\newacronym{sbratio}{SBratio}{ratio of SSB to SSB threshold}
\newacronym{sbrho}{SBrho}{SSB adjusted according to Mohn's rho value}
\newacronym{sbrm}{SBRM}{standard bycatch reporting methodology}
\newacronym{sbtar}{SBTar}{ideal spawning Biomass}
\newacronym{sbtarget}{$SB_{target}$}{theoretically ideal spawning biomass}
\newacronym{sbthr}{SBThr}{threshold for SSB indicating overfished status}
...
<<<<<<< HEAD
\newacronym{scale}{SCALE}{Statistical Catch at Length Model}
\newacronym{scalldr}{scalldr}{scallop dredge}
=======
>>>>>>> 360c3fc (Update special characters in glossary (#425))
...
\newacronym{sk}{SK}{Saltonstall--Kennedy competitive grant}
...
\newacronym{sp}{SP}{stochastic projection}
...
\newacronym{ssbratio}{SSBratio}{ratio of SSB to SSB threshold}
\newacronym{ssbrho}{SSBrho}{SSB adjusted according to Mohn's rho value}
\newacronym{ssbtar}{SSBTar}{ideal spawning Biomass}
\newacronym{ssbtarget}{$SSB_{target}$}{theoretically ideal spawning biomass}
\newacronym{ssbthr}{SSBThr}{threshold for SSB indicating overfished status}
...
\newacronym{survb}{survB}{survey biomass}
...
\newacronym{tmgc}{TMGC}{Transboundary Management Guidance Committee}
\newacronym{tnc}{TNC}{The Nature Conservancy}
\newacronym{tns}{TNS}{Tails n' Scales}
\newacronym{toga}{TOGA}{Type, Operation, Gear, and Acquisition}
...
\newacronym{umass}{UMASS}{University of Massachusetts}
...
\newacronym{waa}{WAA}{Weight-at-age}

...
## History of modeling approaches {#sec-history-of-modeling-approaches}

<!-- Very brief text here for (IT will do) -->

## Response to most recent STAR panel and SSC recommendations {#sec-response-to-most-recent-star-panel-and-ssc-recommendations}
...
## Model Structure and Assumptions {#sec-model-structure-and-assumptions}


### Model Changes from the Last Assessment {#sec-model-changes-from-the-last-assessment}
...
### Modeling Platform and Structure {#sec-modeling-platform-and-structure}
...
### Key Assumptions and Structural Choices {#sec-key-assumptions-and-structural-choices}

...
As a workaround, we recommend commenting out the irrelevant code chunks in your skeleton, then rendering that file to preview the child doc. This way, the report's formatting will be preserved.

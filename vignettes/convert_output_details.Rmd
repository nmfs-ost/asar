...
This article describes the process behind developing the `asar::convert_output` function and its setup so users who want to use `asar` or `satf` are still able until [`convert_output.R`](https://github.com/nmfs-ost/asar/blob/main/R/convert_output.R) includes functionality for other models.

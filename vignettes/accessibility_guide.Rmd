...
### How to view and edit the glossary

The glossary ("report_glossary.tex") is located in your report folder.
...
If your acronym could be read as a regular word- for example, "US" (United States) could also be read as "us" (signifying we, as in a group)- please add periods after each letter. Other examples include "A.R.M." (Adaptive Resource Management Framework) and "S.A.W." (Stock Assessment Workshop).

Find the logical location for your acronym based on alphabetical order. Make a new line and add the following information for your acronym and its meaning, based on this structure:

`\newacronym{<label>}{<acronym ("short form")>}{<meaning ("long form")>}`

Here is an example for NOAA:

...
| All images and non-text elements have alternative text. ||X (We are working on fixing the erroneous alt text.) | |
| Multiple associated images on the same page are grouped together and alternative text for the images has been added. | | |X|
| Multilayered objects (such as charts or graphs) have been flattened into a single image and alternative text for the image has been added. | |X (We are working on fixing the erroneous alt text.)| |

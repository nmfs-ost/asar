...
Then, please check that the glossary contains your acronym, and if it doesn't, add it to the list. The glossary will be saved in your report folder's support_files folder, with the filename "cleaned_acronyms.csv". You can directly edit this csv to add, remove, and/or edit the acronyms, meanings, and definitions.

...
+---------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+
| **Option**                            | **Appropriate if...**                                                                                                                                                                  | **Pros**                                                                                                       | **Cons**                                                                         |
+---------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+
| 1 ("direct image insertion workflow") | -   You don't need to package your table/figure, caption, and alternative text in a single file                                                                                        | -   Faster process                                                                                             | -   Less reproducible                                                            |
|                                       | -   Your table/figure is already saved as an external file (e.g., a png)                                                                                                               |                                                                                                                | -   Files aren't saved in a consistent and predictable system                    |
|                                       | -   Each table/figure is at most 8" wide, or can be shrunken to 8" wide and still be legible                                                                                           |                                                                                                                | -   Captions and alternative text aren't saved with other figures'/tables' texts |
+---------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+
| 2 ("rda-based workflow")              | -   You'd like to create and save your custom tables/figures in a manner that's most consistent with your other tables/figures generated with `asar`'s complementary R package, `satf` | -   More reproducible                                                                                          | -   Slower process                                                               |
...
4.  [Identify table width, orientation, and if splitting is necessary]

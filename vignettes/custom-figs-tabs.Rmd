...
|                                       |                                                                                                                                                                                        |                    |                                                                                                                |
|                                       | -   Each table is at most 12" wide                                                                                                                                                     |                    | -   Files aren't saved in a consistent and predictable system                                                  |
|                                       |                                                                                                                                                                                        |                    |                                                                                                                |
|                                       |                                                                                                                                                                                        |                    | -   Captions and alternative text aren't saved with other figures'/tables' texts                               |
+---------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+----------------------------------------------------------------------------------------------------------------+
| 2 ("rda-based workflow")              | -   You'd like to create and save your custom tables/figures in a manner that's most consistent with your other tables/figures generated with `asar`'s complementary R package, `satf` | -   Slower process | -   More reproducible                                                                                          |
|                                       |                                                                                                                                                                                        |                    |                                                                                                                |
...
*Using the direct image insertion workflow (option 1)? Skip this step and proceed to @sec-write-caps-alttext .*
...
::: callout-warning
Your label must match the label associated with your table or figure in your csv containing the captions and alternative text. If it does not match, the label will not be extracted properly and added to your rdas.
:::
...
<!-- # talk about how to add a file with this link as a resource: -->
<!-- https://quarto.org/docs/authoring/figures.html -->
<!-- # and explain how to measure plot size and make landscape for large plots -->

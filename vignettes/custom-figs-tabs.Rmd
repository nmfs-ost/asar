...
+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| **Option**                         | **Summary**                                                                                                                                                                                                 | **Appropriate if...**                                                                                                                                                                  | **Pros**                                                                                                       | **Cons**                                                                                                                                      |
+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| 1: direct image insertion workflow | In this workflow, you will take minimal steps to add an external file to your report in this format ([see this Quarto documentation for more information](https://quarto.org/docs/authoring/figures.html)): | -   You don't need to package your table/figure, caption, and alternative text in a single file                                                                                        | -   Faster process than option 2                                                                               | -   Less reproducible                                                                                                                         |
|                                    |                                                                                                                                                                                                             | -   Your table/figure is already saved as an external file (e.g., a png)                                                                                                               |                                                                                                                | -   Files (i.e., table/figure, caption, and alternative text) aren't saved in a consistent and predictable system                             |
|                                    | ``` markdown                                                                                                                                                                                                | -   Each table/figure is at most 8" wide, or can be shrunken to 8" wide and still be legible                                                                                           |                                                                                                                | -   Captions and alternative text aren't saved with other figures'/tables' texts                                                              |
|                                    | ![Your caption here](your_image.png){fig-alt="Your alternative text here" width=___in #fig-your_image_label_name}                                                                                           |                                                                                                                                                                                        |                                                                                                                |                                                                                                                                               |
|                                    | ```                                                                                                                                                                                                         |                                                                                                                                                                                        |                                                                                                                |                                                                                                                                               |
+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| 2: rda-based workflow              | In this workflow, you will make an rda containing your table/figure, caption, and alternative text, then add each into your report in the same way that non-custom tables/figures are added.                | -   You'd like to create and save your custom tables/figures in a manner that's most consistent with your other tables/figures generated with `asar`'s complementary R package, `satf` | -   More reproducible                                                                                          | -   Slower process than options 1 & 3                                                                                                         |
|                                    |                                                                                                                                                                                                             |                                                                                                                                                                                        | -   Saves and stores custom tables/figures in a way that mirrors existing tables/figures generated with `satf` |                                                                                                                                               |
+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| 3: direct coding-in-qmd workflow   | In this workflow, you will code, and plot, your table or figure directly in a Quarto document.                                                                                                              | -   You don't need to package your table/figure, caption, and alternative text in a single file                                                                                        | -   Faster process than option 2                                                                               | -   Less reproducible                                                                                                                         |
...
|                                    |                                                                                                                                                                                                             | -   You don't need to export your table/figure                                                                                                                                         | -   Not necessary to import any files to display a table/figure                                                | -   Captions and alternative text aren't saved with other figures'/tables' texts                                                              |
|                                    |                                                                                                                                                                                                             |                                                                                                                                                                                        |                                                                                                                |                                                                                                                                               |
...
1.  [Set up Quarto markdown (.qmd) files to display custom tables and figures](#sec-set-up-qmd)
2.  [Update report skeleton](#sec-update-skeleton)
...
*Using the direct image insertion workflow (option 1)? Skip this step and proceed to @sec-set-up-qmd .*

*Using the direct coding-in-qmd workflow (option 3)? Skip this step and proceed to @sec-id_width .*
...
> **NOTE**: This workflow is reflected in the create_tables_doc.R file and its associated functions (such as `render_lg_table()`, which has its own synonymous R file, and `ID_tbl_width_class()` and `export_split_tbls()`, which are found in the [utils.R](https://github.com/nmfs-ost/asar/blob/main/R/utils.R) file).
...
*If your output is regular*, this means that you can display your table in a .qmd chunk without any additional steps. Jump to section [\@sec-set-up-qmd](#sec-set-up-qmd) and proceed.

*If your output is wide*, this means that you will place your table's .qmd chunk in special braces that change the page orientation to landscape. Jump to section [\@sec-set-up-qmd](#sec-set-up-qmd) and proceed.

*If your output is extra-wide*, this means that you will place your table's .qmd chunk in special braces that change the page orientation to landscape *and* split it into narrower tables, each of which are displayed on separate pages. Proceed to the section @sec-table-splitting.
...
Refer to the table above in section @sec-tbl-width-op2 to find out which category best describes your table width: regular, wide, or extra-wide.

...
```{r echo=F}
data.frame(
  Option = c("1: direct image insertion workflow",
             "2: rda-based workflow",
             "3: direct coding-in-qmd workflow"),
  Summary = c("In this workflow, you will take minimal steps to add an external file to your report in this format:

...
Rerending a skeleton using `rerender = TRUE` can be a helpful and reproducible way to making edits to your skeleton document and leaving a record of your process for future you and future assessment scientists. The current arguments that can be called to adjust your skeleton file when `rerender = TRUE` are:

...
#| eval: false
file.copy(
  from = fs::path("report/Petrale_sole_SAR_2025.pdf"),
  to = fs::path("../../pkgdown/assets"),
  overwrite = TRUE
)
#  
# file.remove("key_quantities.csv")
# file.remove("captions_alt_text.csv")
# file.remove(here::here("readme_output.rda"))
# unlink(fs::path("report"), recursive = T)
```

<iframe src="../../pkgdown/assets/Petrale_sole_SAR_2025.pdf" width="100%" height="600px"></iframe>

<!-- <iframe src="../Petrale_sole_SAR_2025.pdf" width="100%" height="600px"></iframe> -->
